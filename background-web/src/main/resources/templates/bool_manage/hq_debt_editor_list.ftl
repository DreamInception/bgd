<div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">债权编辑管理</a></li>
                <li class="active">债权编辑列表</li>
            </ul>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12 widget-container-col">
                  	...
                  	<div class="widget-body">
                  		<div class="widget-main no-padding">
                  			<aside class='table-search-area'>
                    			...
                    			<button id="select_debt_editor_list" class="btn btn-sm btn-warning" data-toggle="modal">
                                <i class="fa fa-search align-top bigger-125 ace-icon"></i>
                                	查询
                            </button>
                			</aside>
                        <table class="table table-bordered table-row-select" id="hq_debt_editor_list_table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>债权类型</th>
                            ...
                            <tbody>
                       			<#include "hq_debt_editor_refresh.ftl"/>
                             </tbody>
                        </table>
        			...
        			<!-- /.widget-box -->
                   <#include "add_hq_debt_manage.ftl"/>
                   <#include "modify_hq_debt_manage.ftl"/>           
           </div>
            <!-- /.col -->
                </div>
            <!-- /.row -->
