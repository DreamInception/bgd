    ...
    <script type="text/javascript">
  	...
  	$(function(){
  		$("#newBtn").on("click",function(){
  			$.ajax({
  				url:'/collectionPayment/toBuyPayAdd',
  				type:'post',
    	...
    	$.ajax({
    		url:"/collectionPayment/saveBuyPay",
  	...
  	function buyPayRefresh(){
   		$.ajax({
   			url:'/collectionPayment/buyPayRefresh',
   			type:'post',
   			success:function(data){
   				$("#tbody").html("");
   				$("#tbody").html(data);
