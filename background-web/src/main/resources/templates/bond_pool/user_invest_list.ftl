            ...
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <table class="table table-bordered table-row-select" id="list_table">
                            ...
                            <tbody>
                       			<#include "user_invest_refresh.ftl"/>
                             </tbody>
                        </table>
                                ...
                                <#if result??>
                                    ...
                                    <input type="hidden" id="actAutoId" name="cmsAutoId" value="${result.cmsAutoId}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control fileUpload" id="file-edit" name="file"
                                   						value="" placeholder="请选择需要上传的图片">
