                ...
                <div class="col-xs-12">
                        ...
                        <table class="table table-bordered table-row-select" id="list_table">
                            ...
                            <tr>
	                            ...
	                            <th class="hidden-480">是否本地应用打开</th>
	                            <th class="hidden-480">外跳链接</th>
	                            <th class="hidden-480">安卓关键字</th>
	                            <th class="hidden-480">IOS关键字</th>
	                            <th class="hidden-480">排序</th>
	                            <th class="hidden-480">是否显示</th>
                            </tr>
                            </thead>
                            <tbody>
                       			<#include "banner_refresh.ftl"/>
                             </tbody>
                        </table>
