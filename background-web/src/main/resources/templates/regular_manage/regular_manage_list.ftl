                ...
                <div class="col-xs-12 widget-container-col">
                	...
                	<div class="widget-header">
                  	...
                  	<div class="widget-body">
                        ...
                        <table class="table table-bordered table-row-select" id="regular_manage_list_table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>标的名称</th>
                            ...
                            <tbody>
                       			<#include "regular_manage_refresh.ftl"/>
                             </tbody>
                        </table>
                        <div class="clearfix table-bottom-btns">
                            ...
                            <button id="removeBtn" class="btn btn-sm btn-danger" data-toggle="modal"
                                    data-target="#modal-hasdata2"> 
        			...
        			<!-- /.widget-box -->
                    <#include "add_regular_manage.ftl"/>
                    <#include "modify_regular_manage.ftl"/>   
                  </div>
            <!-- /.col -->
                </div>
            <!-- /.row -->
