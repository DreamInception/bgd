                            ...
                            <div class="modal-content">
                            	<div class="modal-header no-padding">
                                 ...
                                 <div class="modal-body">
                                    <form id="insertForm" class="form-horizontal" action="/app-version/insert.do" role="form" enctype="multipart/form-data" method="post">
                                    	...
                                    	<div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right green"
                                                   for="form-field-2">APP类型</label>

                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="appClient" name="appClient"
                                   					value="" placeholder="APP类型">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right green"
                                                   for="form-field-2">版本编码</label>

                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="appVersionStr" name="appVersionStr"
                                   					value="" placeholder="版本编码">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right green"
                                                   for="form-field-3">是否强制更新</label>

                                            <div class="col-sm-6">
                                               <label>
    											<input type="radio" id="isMust" name="isMust" class="ace" value="true" checked="checked" />
    											<span class="lbl" style="padding-left:20px;">&nbsp;&nbsp;是</span>
											</label>
											<label>
    											<input type="radio" id="isMust" name="isMust" class="ace" value="false" />
