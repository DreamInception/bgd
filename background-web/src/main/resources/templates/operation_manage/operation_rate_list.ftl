                ...
                <div class="col-xs-12 widget-container-col">
                	...
                	<div class="widget-header">
                  	...
                  	<div class="widget-body">
                        ...
                        <table class="table table-bordered table-row-select" id="operation_rate_list_table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>赠送用户</th>
                            ...
                            <tbody>
                       			<#include "operation_rate_refresh.ftl"/>
                             </tbody>
                        </table>
