                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="umactId" id="umactId" value="" />
                                        ...
                                        <div class="form-group pos-rel">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 12px;">
                                                <input type="text" class="form-control date-picker" placeholder="开始日期"
                                                       id="ubeginDate" name="ubeginDate" data-date-format="yyyy-mm-dd" style="padding-left: 12px;"/>
                                            </div>
                                            <div class="mark-pos">
                                            *
                                            </div>
                                            ...
                                            <label class="col-sm-3 control-label no-padding-right green"
   											...
   											<div class="col-sm-6" style="padding-left: 12px;">
                                                <input type="text" class="form-control date-picker" placeholder="截止日期"
                                                       id="uendDate" name="uendDate" data-date-format="yyyy-mm-dd" style="padding-left: 12px;"/>
                                            </div>
                                            <div class="mark-pos">
                                            *
                                            </div>
                                ...
                                <div class="modal-footer clearfix">
                                    <div class="center">
                                        <button type="button" class="btn btn-sm btn-success" id="reg-activity-modify">
