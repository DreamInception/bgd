<div class="widget-box col-sm-6 widget-color-blue collapsed pull-right" id="widget-box-cou" style="margin-top: 30px;">
            		...
            		<div class="widget-body">
            			...
            			<form class="form-horizontal" style="margin-top:12px;" role="form" id="activity_manage_form">
                                        <div class="form-group pos-rel">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 12px;">
                                                 <input type="text" class="form-control" placeholder="加息年利率"
                                                       id="add-year-rate2" name="add-year-rate"/>
                                            </div>
                                            ...
                                            <label class="col-sm-3 control-label no-padding-right green"
   											...
   											<div class="col-sm-6" style="padding-left: 12px;">
                                                  <input type="text" class="form-control" placeholder="加息天利率"
                                                       id="add-day-rate2" name="add-day-rate" disabled="disabled"/>
                                            </div>
                                            <div class="mark-pos" style="right: 170px;">
                                            *
                                            </div>
                                        ...
                                        <div class="form-group pos-rel">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" placeholder="加息天数"
                                                       id="add-rate-days2" name="add-rate-days"/>
                                            </div>
                                            <div class="mark-pos" style="right: 170px;">
                                            *
                                            </div>
                                        ...
                                        <div class="form-group pos-rel">
                                            ...
                                            <div class="col-sm-6" style="padding-left: 12px;">
                                                 <input type="text" class="form-control" placeholder="有效天数"
                                                       id="during-days2" name="during-days"/>
                                            </div>
                                            <div class="mark-pos" style="right: 170px;">
                                            *
                                            </div>
                          ...
                          <table class="table table-bordered table-row-select2" style="display:none;" id="ram_cou_table">
                            <thead>
                            <tr class="table-row">
                                <th>加息年利率</th>
                                <th>加息天利率</th>
            		...
            		<div class="widget-toolbox padding-12 clearfix  table-bottom-btns">
   						<button class="btn btn-sm btn-primary" id="add-coupon-btn">
