...
<!-- setting box goes here if needed -->
		<div class="page-content-area">
            ...
            <div class="row">
                <div class="col-sm-6 widget-container-col">
                	...
                	<div class="widget-header">
                  	...
                  	<div class="widget-body">
                        ...
                        <table class="table table-bordered table-row-select" id="act_reg_gift_manage_list_table">
                            ...
                            <tbody>
                       			<#include "reg_activity_manage_refresh.ftl"/>
                             </tbody>
                        </table>
                        <div class="clearfix table-bottom-btns">
                            ...
                            <button id="modifyBtn" class="btn btn-sm btn-info" data-toggle="modal"
                                    data-target="#modal-nodata2">
                            ...
                            <button id="regOnsaleBtn" class="btn btn-sm btn-danger">
        			...
        			<!-- /.widget-box -->
                     <#include "add_reg_activity_manage.ftl"/>
                     <#include "modify_reg_activity_manage.ftl"/>
                  </div>
            <!-- /.col -->
            <!-- 体验金列表  -->
            <#include "../reg_activity/add_money_manage.ftl"/>  		
            <!-- /.row -->
            <!-- 加息券列表  -->
            <#include "../reg_activity/add_rate_manage.ftl"/> 
         </div>
            <!-- /.row -->
        ...
        <!-- /.page-content -->
        <#include "reg_select_activity_table.ftl"> 