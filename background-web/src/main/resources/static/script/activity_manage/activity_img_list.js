	...
	$("#changeBtn").click(
			function() {
				...
				if (idList.length > 1) {
					...
					$.ajax({
						url : '/activity-img/selectByPrimaryKey.do?cmsAutoId='
								+ idList,
						type : 'POST',
						dataType : 'json',
						cache : true,
	...
	$("#removeBtn").click(
			function() {
				...
				if (idList.length > 1) {
					...
					$.ajax({
						url : '/activity-img/deleteByPrimaryKey.do?cmsAutoId='
								+ idList,
						type : 'POST',
						dataType : 'html',
						cache : true,
